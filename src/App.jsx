...
const DAY3_ROUNDS = [
  ...
  },
  {
    ...
    lobbies: [
      {
        id: "A",
        teamIds: [1778755101008, 1778745140879, 1778744964447, 1778755029752],
        results: {
          "1778755101008": { placement: 1, kills: 7 },
          "1778745140879": { placement: 3, kills: 1 },
          "1778744964447": { placement: 2, kills: 1 },
          "1778755029752": { placement: 4, kills: 0 },
        },
      },
      {
        id: "B",
        teamIds: [1778745060568, 1778754685072, 1778754946904, 1778745028175],
        results: {
          "1778745060568": { placement: 2, kills: 3 },
          "1778754685072": { placement: 1, kills: 5 },
          "1778754946904": { placement: 3, kills: 1 },
          "1778745028175": { placement: 4, kills: 0 },
        },
      },
    ],
  },
  {
    ...
    lobbies: [
      {
        id: "A",
        teamIds: [1778755029752, 1778755101008, 1778745140879, 1778754946904],
        results: {
          "1778755029752": { placement: 4, kills: 3 },
          "1778755101008": { placement: 2, kills: 5 },
          "1778745140879": { placement: 3, kills: 1 },
          "1778754946904": { placement: 1, kills: 5 },
        },
      },
      {
        id: "B",
        teamIds: [1778745028175, 1778744964447, 1778754851560, 1778754685072],
        results: {
          "1778745028175": { placement: 1, kills: 5 },
          "1778744964447": { placement: 2, kills: 6 },
          "1778754851560": { placement: 4, kills: 2 },
          "1778754685072": { placement: 3, kills: 2 },
        },
      },
    ],
  },
  {
    ...
    lobbies: [
      {
        id: "A",
        teamIds: [1778745140879, 1778745028175, 1778754823864, 1778755101008, 1778744964447],
        results: {
          "1778745140879": { placement: 4, kills: 1 },
          "1778745028175": { placement: 3, kills: 1 },
          "1778754823864": { placement: 5, kills: 0 },
          "1778755101008": { placement: 2, kills: 5 },
          "1778744964447": { placement: 1, kills: 1 },
        },
      },
      {
        id: "B",
        teamIds: [1778755029752, 1778754946904, 1778754851560, 1778754685072, 1778760000001],
        results: {
          "1778755029752": { placement: 2, kills: 5 },
          "1778754946904": { placement: 5, kills: 1 },
          "1778754851560": { placement: 3, kills: 2 },
          "1778754685072": { placement: 4, kills: 4 },
          "1778760000001": { placement: 1, kills: 3 },
        },
      },
    ],
  },
